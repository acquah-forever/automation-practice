...
const Price = () => {
    return (
        <div className='flex flex-col justify-center items-center'>
            ...
            <div className='px-10 max-w-8xl bg-red-300 grid md:grid-cols-2 lg:grid-cols-3 justify-items-center items-center'>

                <div className='flex flex-col max-w-xs h-115 px-7 py-10 border rounded-xl'>
