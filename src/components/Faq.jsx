...
const Faq = () => {
    ...
    return (
        <div className='mt-30 flex flex-col justify-center items-center'>
            ...
            <div>
                <div className='bg-slate-300 p-3 mb-1 rounded-lg max-w-xl flex justify-between items-center' onClick={() => handleClick(2)}>
                    <h1>Wshat is kojo and how does it helps developers?</h1>
            ...
            <div>
                <div className='bg-slate-300 p-3 mb-1 rounded-lg max-w-xl flex justify-between items-center' onClick={() => handleClick(3)}>
            ...
            <div>
                <div className='bg-slate-300 p-3 mb-1 rounded-lg max-w-xl flex justify-between items-center' onClick={() => handleClick(4)}>
            ...
            <div>
                <div className='bg-slate-300 p-3 mb-1 rounded-lg max-w-xl flex justify-between items-center' onClick={() => handleClick(5)}>
